export default function InsertMovies() {
    console.log(process.env.serverUrl + '/movie/all')
    const obj = fetch(process.env.serverUrl + '/movie/all', {
        method: 'GET',
        ...
        res.json().then((data) => {
            if (data.length == 0) {
                ...
                fetch(process.env.serverUrl + '/movie/new', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
